...
class TestView(TestCase):
    ...
    def navbar_test(self, soup):
        ...
        # print('logo_btn : ',logo_btn)  # <class ="navbar-brand" href="./index.html" > Do It Django < / a >
        # print('logo_btn.attrs : ',logo_btn.attrs)  # {'class': ['navbar-brand'], 'href': './index.html'}
    ...
    def test_post_list(self):
        ...
        # print('response :', response) # <TemplateResponse status_code=200, "text/html; charset=utf-8">
        ...
        # print('main_area.text : ',main_area.text)
    ...
    def test_create_post(self):
        # 로그인 하지 않으면 status_code 가 200이면 안된다.
    ...
    def test_delete_comment(self):
        ...
        comment_area =soup.find('div', id='comment-area')
        self.assertFalse(comment_area.find('a', id='comment-1-delete-btn'))
        comment_002_delete_madal_btn = comment_area.find('a', id='comment-2-delete-modal-btn')
        self.assertIn('delete', comment_002_delete_madal_btn.text)
        self.assertEqual(comment_002_delete_madal_btn.attrs['data-target'], '#deleteCommentModal-2')
